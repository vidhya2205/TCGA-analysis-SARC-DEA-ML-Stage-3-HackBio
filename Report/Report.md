...
<p align = center>
  <kbd>
<img src="https://lh7-rt.googleusercontent.com/docsz/AD_4nXcNjIyWYQ8SKELVYk0_wPchMDsfPBcf-sBjrk1cQqLvJvIx19Q9xle5AuSQfvlwFsweFUCCHfd90u3zreTYTeghe1f_GKNLFzlHuuTOBO1do-uVW1s_eebCYyyCX5O1N_Bj95LNY4KHPzkBaA580LWa0wa-?key=xvw3JB3jr1ZpthYtl54CPw" width="400" height = "400">
  </kbd>
  </p>
...
Based on the DGEA and FEA of the RNA-seq TCGA data from sarcoma patients, classified on the basis of age into AYA and OA patients, significant biomarkers have been identified in the current project. Though many of the identified top 5 differentially regulated genes (up and down) have a role linked to cancer and to sarcoma in some cases, their role in AYA patients is not established. Future studies can be directed to explore the role of these genes in the subgroup of patients. Moreover, with increasing interest in the role of lncRNAs in sarcoma pathogenesis and progression (Wang K _et al_., 2020; Min L _et al_., 2017), the identified dysregulated lncRNAs, though not characterized yet, can pave the way to new research. Additionally, the differentially regulated protein-coding genes identified by _in-silico_ methods in the current study can be validated by _in vivo_ and _in vitro_ assays for their role as age-based biomarkers and role in sarcoma. Dysregulated in the immune response pathways, important pathways associated with cancer progression and cancer stem cell-like properties indicate a significant difference in the progression and therapy response between the two groups compared. Furthermore, the integration of multi-omics can contribute to a more comprehensive disease profile which will aid in a better understanding of sarcoma and developing suitable therapeutic targets and diagnostic biomarkers for each age group. The study has some limitations due to the limited number of samples and uneven distribution of subtypes in the 2 groups, hence a larger study with even distribution could provide more accurate insights.
